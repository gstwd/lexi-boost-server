...
from app.data.repositories import StudyRecordRepository, WordRecordRepository
from app.exceptions import APIException


class StudyService:
    def __init__(self, word_repository: WordRecordRepository, study_record_repository: StudyRecordRepository):
    ...
    def save_study_result(self, word_id: int, status: str) -> StudyRecordDTO:
        ...
        if not word:
            raise APIException("WordRecord not found", error_code=1002, status_code=404)
